...
export default function AboutMe() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.text}>
        When you take a picture of a parking sign, the app uses machine learning to analyze the image and provide you with information about the parking rules. The app will tell you if you can park there, when you can park there, and if there are any restrictions. If the app is unable to analyze the image, it will let you know. Under the hood we are using OpenAI's gpt-4o-mini model. The app was built in 2 days with Expo and React Native.
      </Text>
